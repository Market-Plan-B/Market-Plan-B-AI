...
from app.nodes.actiongenerator import actiongenerator
from app.nodes.reportgenerator import reportgenerator
...
# 그래서 오늘 어제꺼만 들어감 
structured_data = pd.read_csv('app/data/llm_input_sample.csv') ## 여기에 모델 추론에 들어가는 데이터 데려오면 됨
...
with open('app/data/extra_embedded(1).json', 'r', encoding='utf-8') as f:
